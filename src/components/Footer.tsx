  ...
  return (
    <footer className="bg-secondary text-white py-16">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-white/70 mb-5">
              Enterprise-grade IT solutions for businesses throughout Loganville 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-white/70 hover:text-white transition-colors">Managed IT Services</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-white/70 hover:text-white transition-colors">Our Approach</a>
              </li>
              <li>
        ...
        <div className="pt-12 mt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/70 text-sm">
            &copy; {currentYear} Anderson IT Consulting. All rights reserved.
          </p>
